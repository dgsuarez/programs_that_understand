...
# We can solve both those problems by separating the actual state machine logic
# from the macro code. These 2 classes can be tested independently.
...
# There's still problems with this approach: How can I create a closed `Door`? How
